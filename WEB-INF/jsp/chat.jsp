    ...
    <script type="text/javascript">
        ...
        function startWebSocket() {
            if ('WebSocket' in window)
                ws = new WebSocket("ws://localhost:3377/lwh/websocket/linweiheng");
            else if ('MozWebSocket' in window)
                ws = new MozWebSocket("ws://localhost:3377/lwh/websocket/linweiheng");
            else
                alert("not support");
...
<br> To：
<select id='userlist'>
</select><span style="color: red;">*</span>请选择聊天对象
<br> 发送内容：
